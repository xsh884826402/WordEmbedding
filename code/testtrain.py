...
aaa=pd.read_csv(f'/data1/embedding/sqldata/embsqltest{todayy}.csv',sep='\t',error_bad_lines=False)
...
fw = open(f'/data1/embedding/traindata/traindatatest{todayy}.txt', 'w+')
